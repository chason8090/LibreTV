// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["tyyszy","mdzy","dyttzy","bfzy","ruyi","bfzy","ffzy","heimuer","zy360","iqiyi","wolong","hwba","jisu","dbzy","mozhua","zuid","yinghua","baidu","wujin","wwzy","ikun"]'); // 默认选中资源
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中资源
        selectedAPIs = ["tyyszy","mdzy","dyttzy","bfzy","ruyi","bfzy","ffzy","heimuer","zy360","iqiyi","wolong","hwba","jisu","dbzy","mozhua","zuid","yinghua","baidu","wujin","wwzy","ikun"];
